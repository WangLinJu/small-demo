 ...
 * @since 2020-08-12
 */
@TableName("BOM_MANUFACTURE_MATERIAL")
@ApiModel(value="BomManufactureMaterial对象", description="工艺BOM物料表")
public class BomManufactureMaterial implements Serializable {
    ...
    @ApiModelProperty(value = "虚拟件标识：x (小写的x)")
